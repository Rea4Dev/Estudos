...
# Condicional 1 "Sim"
    with open ('historico.csv', 'w', newline='') as documento: # documento criado/sobrescrito
        ...
        csv.writer(documento).writerows(dados_BD) # escreve as linhas com base na armazenagem intermediaria. Linha 14 garante quebra de linha entre infos.
...
# Condicional 1 "Não"
    with open ('historico.csv', 'r+', newline='', encoding='utf-8') as documento:
        ...
        for linhaBD in dados_BD:
            ...
            for n, linha in enumerate(lista_documento[1:]):
                i += 1
                ...
                if (action_id_bd == action_id_linha_hist): # Condicional 2     
                    if ((status_linha_bd == status_linha_hist) or (status_linha_hist == "" and status_linha_bd == "None")): # Condicional 2 "Sim" | # Condicional 3 | # compara STATUS 
                        ...
                        csv.writer(documento).writerow(linhaBD) 
